...
class BaseTrainer:
    def __init__(self, model, loss, resume, config, train_loader, val_loader=None, train_logger=None):
        ...
        self.improved = False
                ...
                # Create an comet experiment with your api key
        config_dict = None
        with open('comet.json', 'r') as config_file:
            config_dict = json.load(config_file)
        
        self.experiment = Experiment(log_graph=True,auto_metric_logging=True ,
                api_key=config_dict[ "comet"]["api_key"],
                project_name=config_dict[ "comet"]["project_name"],
                workspace=config_dict[ "comet"]["workspace"],
            )
        ...
        # ToDo: check why tensorboard not stable , sys crash
    ...
    def eval_weights(self):
        # Tidy this code , its just a copy of train function
        epoch = 1
        # RUN eval
        if True:
    ...
    def _resume_checkpoint(self, resume_path):
        ...
        try: 
            ...
            print("ERROR ERROR load optamizer")
